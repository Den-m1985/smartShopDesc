package org.example.service.product.bolshe_podarkov.search_and_add;

import org.example.DTO.DtoError;
import org.example.enums.TextLinks;
import org.example.service.BasicLanguageManager;
import org.example.service.product.bolshe_podarkov.search_and_add.addToBasket.AddGood;
import org.example.service.product.bolshe_podarkov.search_and_add.checkGood.CheckAvailability;
import org.example.service.product.bolshe_podarkov.search_and_add.checkGood.CheckPrice;
import org.example.service.product.bolshe_podarkov.search_and_add.checkGood.CountProduct;
import org.example.service.product.bolshe_podarkov.search_and_add.checkGood.GetPrice;
import org.example.service.product.bolshe_podarkov.search_and_add.search.SearchGoods;
    ...
    public ServiceAddToBasket(BrowserManager browserManager, List<StructureCSV> data) {
        ...
        for (StructureCSV product : data) {
            try {
                ...
                switch (countProduct) {
                    case 0 -> errorMessages.add(new DtoError(product.getName(), product.getArticular(),
