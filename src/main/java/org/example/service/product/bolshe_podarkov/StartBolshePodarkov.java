...
import org.example.service.product.bolshe_podarkov.search_and_add.ServiceAddToBasket;
import org.example.service.product.bolshe_podarkov.search_and_add.addToBasket.Basket;
...
public class StartBolshePodarkov extends AbstractStartProcess {
    ...
    protected void startController() throws Exception {
        ...
        browserManager = webElementsUtil;
